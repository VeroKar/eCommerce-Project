...
<div class= "container">
        ...
        <div class="dropdown filterDropdown mx-2">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <div class="container">
                    ...
                    <a href="/WebsiteMVC/Gift/index" class="link-dark">CLEAR ALL</a>
                </div>
                </form>
            </ul>
    ...
    <!-- Sort by price products -->
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item"  href="/WebsiteMVC/Gift/sortByAscendingPrice">Price: Low to High</a></li>
                <li><a class="dropdown-item"  href="/WebsiteMVC/Gift/sortByDescendingPrice">Price: High to Low</a></li>
            </ul>
        </div>
</div>
        ...
        foreach($data["products"] as $product)
        {
            ...
            echo'<form action="index.php" method="post">';  
                    echo'<div class="card shadow">
                        <a href="/WebsiteMVC/Gift/details/'. $product->productId.'">
